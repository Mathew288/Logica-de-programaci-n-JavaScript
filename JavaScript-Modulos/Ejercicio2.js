...
export const invertirCadena = (cadena = "") => {
    if(cadena === ""){
        ...
        // Split("") toma todos los caracteres de la cadena y los transforma en 
        // un array. reverse() invierte el orden del array. join("") unirá
        // todos los caracteres invertidos por la funcion reverse 
    }
}
